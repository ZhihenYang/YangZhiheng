<template>
    <div class="views-chelianglichang-updt">
        <div>
...
<script setup>
    ...
    import { useChelianglichangFindById, canChelianglichangFindById, canChelianglichangUpdate, canCheliangruchangFindById } from "@/module";
    ...
    const form = useChelianglichangFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canChelianglichangUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
