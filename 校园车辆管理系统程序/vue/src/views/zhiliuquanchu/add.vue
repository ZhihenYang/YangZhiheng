<template>
    <div class="views-zhiliuquanchu-add">
        <div>
...
<script setup>
    ...
    import { useZhiliuquanchuCreateForm, canZhiliuquanchuInsert } from "@/module";
    ...
    const { form } = useZhiliuquanchuCreateForm();
    ...
    var submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canZhiliuquanchuInsert(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
