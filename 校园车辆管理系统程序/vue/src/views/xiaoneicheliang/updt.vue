<template>
    <div class="views-xiaoneicheliang-updt">
        <div>
            <el-card class="box-card">
                ...
                <el-form :model="form" ref="formModel" label-width="140px" status-icon validate-on-rule-change>
                    <el-form-item
                        ...
                        required
                        :rules="[{required:true, message:'请填写车辆编号'}, {validator:rule.checkRemote, message:'内容重复了', checktype:'update', module:'xiaoneicheliang', col:'cheliangbianhao', id:form.id, trigger:'blur'}]"
                    >
                    ...
                    <el-form-item
                        ...
                        prop="cheliangpaihao"
                        required
                        :rules="[{required:true, message:'请填写车辆牌号'}, {validator:rule.checkRemote, message:'内容重复了', checktype:'update', module:'xiaoneicheliang', col:'cheliangpaihao', id:form.id, trigger:'blur'}]"
                    >
...
<script setup>
    ...
    import { useXiaoneicheliangFindById, canXiaoneicheliangFindById, canXiaoneicheliangUpdate } from "@/module";
    ...
    const form = useXiaoneicheliangFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canXiaoneicheliangUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
