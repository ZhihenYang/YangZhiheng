<template>
    <div class="views-shengyuchewei-add">
        <div>
...
<script setup>
    ...
    import { useShengyucheweiCreateForm, canShengyucheweiInsert } from "@/module";
    ...
    const { form, readMap } = useShengyucheweiCreateForm(props.id);
    ...
    var submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canShengyucheweiInsert(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
