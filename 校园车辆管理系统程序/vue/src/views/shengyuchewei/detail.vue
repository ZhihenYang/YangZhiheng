<template>
    <div class="views-shengyuchewei-detail">
        <div>
            <el-card class="box-card">
                ...
                <div id="printdetail">
                    <el-descriptions class="margin-top" :column="3" border>
                        ...
                        <el-descriptions-item label="剩余车位"> {{ map.shengyuchewei }} </el-descriptions-item>
                        <el-descriptions-item label="说明"> {{ map.shuoming }} </el-descriptions-item>
                    </el-descriptions>
...
<script setup>
    ...
    import { useShengyucheweiFindById, canShengyucheweiFindById } from "@/module";
    ...
    const map = useShengyucheweiFindById(props.id);
