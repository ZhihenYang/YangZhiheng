        ...
        <div>
            <el-card class="box-card">
                ...
                <div class="form-search">
                    <el-form @submit.prevent.stop :inline="true" size="small">
                        <el-form-item label="权限">
                            <el-select v-model="search.cx"
                                ><el-option label="请选择" value=""></el-option><el-option label="超级管理员" value="超级管理员"></el-option>
                ...
                <el-table border :data="lists" style="width: 100%" @sort-change="sortChange" highlight-current-row>
                    ...
                    <el-table-column prop="cx" label="权限" width="120">
                        <template #default="{row}"> {{ row.cx }} </template>
                    </el-table-column>
                    <el-table-column prop="username" label="帐号" width="130">
                        ...
                        <template #default="{row}">
                            <el-button-group>
                                <el-tooltip effect="dark" content="详情" placement="top-start"
                                    ><el-button type="info" :icon="InfoFilled" size="small" @click="$router.push('/admin/admins/detail?id='+row.id)">详情</el-button>
                                </el-tooltip>

                                <el-tooltip v-if="row.cx == '管理员'" effect="dark" content="编辑" placement="top-start"
                                    ><el-button type="success" :icon="Edit" size="small" @click="$router.push('/admin/admins/updt?id='+row.id)">编辑</el-button>
                                </el-tooltip>
                                <el-tooltip v-if="row.cx == '管理员'" effect="dark" content="删除" placement="top-start"
