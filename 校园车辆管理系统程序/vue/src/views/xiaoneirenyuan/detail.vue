<template>
    <div class="views-xiaoneirenyuan-detail">
        <div>
...
<script setup>
    ...
    import { useXiaoneirenyuanFindById, canXiaoneirenyuanFindById } from "@/module";
    ...
    const map = useXiaoneirenyuanFindById(props.id);
