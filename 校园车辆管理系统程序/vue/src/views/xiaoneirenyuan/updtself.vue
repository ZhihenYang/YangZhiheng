<template>
    <div class="views-xiaoneirenyuan-updtself">
        <div>
            <el-card class="box-card">
                ...
                <el-form :model="form" ref="formModel" label-width="140px" status-icon validate-on-rule-change>
                    ...
                    >
                        <el-input disabled type="text" placeholder="输入工号" style="width: 450px" v-model="form.gonghao" />
                    </el-form-item>

                    <el-form-item label="姓名" prop="xingming" required :rules="[{required:true, message:'请填写姓名'}]">
                        <el-input disabled type="text" placeholder="输入姓名" style="width: 450px" v-model="form.xingming" />
                    </el-form-item>
