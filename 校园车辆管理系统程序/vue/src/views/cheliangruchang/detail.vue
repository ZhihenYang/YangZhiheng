<template>
    <div class="views-cheliangruchang-detail">
        <div>
            <el-card class="box-card">
                ...
                <div id="printdetail">
                    <el-descriptions class="margin-top" :column="3" border>
                        ...
                        <el-descriptions-item label="入场说明"> {{ map.ruchangshuoming }} </el-descriptions-item>
...
<script setup>
    ...
    import { useCheliangruchangFindById, canCheliangruchangFindById } from "@/module";
    ...
    const map = useCheliangruchangFindById(props.id);
