            ...
            <el-card class="box-card">
                ...
                <div id="printdetail">
                    <el-descriptions class="margin-top" :column="3" border>
                        ...
                        <el-descriptions-item label="取消时间"> {{ map.addtime }} </el-descriptions-item>
                    </el-descriptions>

                    <el-descriptions direction="vertical" class="margin-top" :column="1" border>
                        <el-descriptions-item label="取消原因"> {{ map.quxiaoyuanyin }} </el-descriptions-item>
                    </el-descriptions>
                </div>
...
<script setup>
    ...
    import { useQuxiaoFindById, canQuxiaoFindById } from "@/module";
    ...
    const map = useQuxiaoFindById(props.id);
