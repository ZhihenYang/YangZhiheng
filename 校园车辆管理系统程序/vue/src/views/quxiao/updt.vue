...
<script setup>
    ...
    import { useQuxiaoFindById, canQuxiaoFindById, canQuxiaoUpdate, canYuyueFindById } from "@/module";
    ...
    const form = useQuxiaoFindById(props.id);
