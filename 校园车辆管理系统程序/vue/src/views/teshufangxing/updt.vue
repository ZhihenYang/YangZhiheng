<template>
    <div class="views-teshufangxing-updt">
        <div>
...
<script setup>
    ...
    import { useTeshufangxingFindById, canTeshufangxingFindById, canTeshufangxingUpdate } from "@/module";
    ...
    const form = useTeshufangxingFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canTeshufangxingUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
